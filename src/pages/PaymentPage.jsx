      ...
      <header ref={headerRef} className="relative z-10 py-8 px-4 md:px-8 lg:px-16 xl:px-24">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="flex items-center justify-between">
            ...
            {/* Security Badge */}
            <div ref={lockIconRef} className="hidden md:flex items-center gap-2 bg-emerald-50 border border-emerald-200 rounded-full px-4 py-2">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <Input
                    ...
                    className={`mt-1.5 text-lg tracking-wider ${errors.cardNumber ? 'border-red-500' : ''}`}
                ...
                {/* Cardholder Name */}
                <div>
                  <Label htmlFor="cardName" className="text-gray-700 flex items-center gap-2">
                  ...
                  <Input
                    ...
                    className={`mt-1.5 ${errors.cardName ? 'border-red-500' : ''}`}
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="expiryDate" className="text-gray-700 flex items-center gap-2">
                  ...
                  <div>
                    <Label htmlFor="cvv" className="text-gray-700 flex items-center gap-2">
                ...
                <Button
                  ...
                  className="w-full h-14 bg-emerald-600 hover:bg-emerald-700 text-white text-lg font-semibold transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isProcessing ? (
